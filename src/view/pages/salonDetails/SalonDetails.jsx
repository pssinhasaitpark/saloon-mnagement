...
//         </div>
//         {/* Main Content */}
//         <div className="bg-white rounded-xl shadow-lg overflow-hidden md:col-span-10 p-4">
//           {/* Header Banner */}
...
//                     {Array.isArray(salon.businessHours)
//                       ? salon.businessHours.map(
//                           (
//                             [day, hours] // This won't run because businessHours is an object
//                           ) => (
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 w-full md:col-span-3">
            ...
            <div className="bg-gray-50 p-8 rounded-lg mb-4">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2">{salon.phone || "(555) 123-4567"}</span>
              </div>
              <div className="flex items-center mb-4">
                <span className="font-medium">Email:</span>
                <span className="ml-2">
                  {salon.email ||
                    `info@${salon.name.toLowerCase().replace(/\s+/g, "")}.com`}
                </span>
              </div>
              <div className="flex items-center">
